...
function aplicarMascaraCm(campo) {
    ...
    campo.addEventListener("blur", () => {
        ...
        if (!regexCmValido.test(campo.value)) {
            alert("Valor inválido! Use o formato 999,99 cm.");
            campo.value = "";
        }
    });
}
...
function aplicarMascaraKg(campo) {
    ...
    campo.addEventListener("blur", () => {
        ...
        if (!regexKgValido.test(campo.value)) {
            alert("Valor inválido! Use o formato 99,99 kg.");
            campo.value = "";
        }
    });
}
...
export { aplicarMascaraTelefone, aplicarMascaraMonetario, aplicarMascaraCm, aplicarMascaraKg };
